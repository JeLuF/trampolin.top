...
function addIndividualTable(parent, title, wk, uebungen, phase) {
    ...
    if (wk["bestesergebnisq1"] == "true") {
        vk1 = '<span class="lang">Erste Übung</span><span class="kurz">1.Üb.</span>'
        vk2 = '<span class="lang">Zweite Übung</span><span class="kurz">2.Üb.</span>'
    }
    ...
    uebungen.filter((ue) => ue.phase == phase).forEach( (ue) => {
        if (phase >= 2) {
            if (wk["finaleabnull"] == "true") {
                ue.ergebnis = ue.erg1 === null ? "" : ue.erg1;
            } else {
            ...
            if (ue.erg1 === null) {
                ...
                ue.ergebnis = Math.max(ue.erg1, ue.erg2);
            } else {
                ue.ergebnis = (ue.erg1 + ue.erg2);
            }
        }
        if (wk["wettkampftypid"] == "de.balticscore.turnen.trampolin2022.grossgeraet.synchronfig") {
            ue.vorname = ""
            ue.name = ue.name + " / " + ue.partner_name
        }
        reihenfolge.push(ue)
    })
            ...
            if (phase >= 2) {
                ...
                if (wk["wettkampftypid"] == "de.balticscore.turnen.trampolin2022.grossgeraet.synchronfig") {
                    ...
                    <div class="finale closed">
                        <div class="Platz icon-container">${Platzanzeige}</div>
                    ...
                    <div class="finale closed">
                        ...
                        <div class="punkte">${ergebnis}</div>
                        <div class="Details">
                            <div class="h_spruenge"><span class="lang">Spr&uuml;nge</span><span class="kurz">Sp</span></div>
                            <div class="h_haltung"><span class="lang">Haltung</span><span class="kurz">E</span></div>
                            <div class="h_schwierigkeit"><span class="lang">Schwierigkeit</span><span class="kurz">D</span></div>
                            <div class="h_tof"><span class="lang">Flugzeit</span><span class="kurz">ToF</span></div>
                            <div class="h_hd">HD</div>
                            <div class="h_strafwert"><span class="lang">Strafwert</span><span class="kurz">Strafe</span></div>
                            <div class="h_punkte"><span class="lang">Punkte</span><span class="kurz">Pkt</span></div>
                            <div class="spruenge1">${ue.ue1.anzahluebungsteile}</div>
                ...
                const erg1 = ue.erg1 === null ? "" : parseFloat(ue.erg1).toFixed(2)
                const erg2 = ue.erg2 === null ? "" : parseFloat(ue.erg2).toFixed(2)

                var keys = ["anzahluebungsteile", "haltung", "schwierigkeit", "timeofflight", "horizontaleabweichung"];
                keys.forEach((k) => {
                ...
                ue.ue1.haltung = ue.ue1.haltung == "" ? "" : parseFloat(ue.ue1.haltung).toFixed(2)
                ue.ue2.haltung = ue.ue2.haltung == "" ? "" : parseFloat(ue.ue2.haltung).toFixed(2)
                    ...
                    el.innerHTML = `
                        <div class="vorkampf closed ${clickable}">
                          ...
                          <div class="Details">
                            ...
                            <div class="spruenge2">${ue.ue2.anzahluebungsteile}</div>
